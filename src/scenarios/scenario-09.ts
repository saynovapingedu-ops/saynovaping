...
export const scenario09: Scenario = {
  ...
  nodes: [
    ...
    // มินิเกมหลัก: เรียงสูตร 5A
    {
      ...
      title: 'ขั้นตอน 5A ช่วยเพื่อนเลิก — เรียงลำดับให้ถูกต้อง',
      cards: [
        { id: 'a1', text: 'ถาม (Ask) — ถามอย่างเปิดใจ ไม่ตัดสิน "รู้สึกยังไงบ้าง"' },
        { id: 'a2', text: 'แนะนำ (Advise) — ให้คำแนะนำกระชับ ชัดเจน ไม่กดดัน' },
        { id: 'a3', text: 'ประเมิน (Assess) — ดูว่าเขาพร้อมและอยากเลิกขั้นไหน' },
        { id: 'a4', text: 'ช่วยเหลือ (Assist) — วางแผน + ต่อสาย 1600 (Quit Line ปรึกษาเลิกฟรี 24 ชม.)' },
        { id: 'a5', text: 'ติดตาม (Arrange) — นัดติดตามผล คอยอยู่เคียงข้างให้กำลังใจ' },
      ],
