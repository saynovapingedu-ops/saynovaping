      ...
      claims: [
        {
          ...
          isLie: true,
          reveal: 'โฆษณาแฝง — รหัสคำพูด + ส่วนลด + ไม่บอกสินค้า = รูปแบบการขายบุหรี่ไฟฟ้า',
        ...
        {
          text: '"พอตทดลองฟรี! แค่ส่งที่อยู่ในข้อความส่วนตัว (DM) ไม่บอกใคร"',
          isLie: true,
          reveal: 'โฆษณาแฝง + ผิดกฎหมายชัดเจน — "ไม่บอกใคร" คือคำเตือน',
          source: 'พ.ร.บ. ศุลกากร 2560',
        },
        {
          text: '"ปรึกษาเลิกบุหรี่/บุหรี่ไฟฟ้า โทร 1600 ฟรี 24 ชม."',
          isLie: false,
          reveal: 'ของจริง — 1600 คือ Quit Line ของศูนย์บริการเลิกบุหรี่แห่งชาติ (กรมการแพทย์) คุยกับนักจิตวิทยาโดยตรง ฟรี เก็บข้อมูลเป็นความลับ',
