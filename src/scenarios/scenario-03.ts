  ...
  nodes: [
    ...
    },
    {
      ...
      choices: [
        ...
        {
          label: 'นายอยากติดทีมบอลใช่ปะ อันนี้มันพังปอด วิ่งไม่ไหวแน่',
          next: 'right1', xp: 30,
        },
        {
    ...
    },
    {
      ...
      choices: [
        { label: 'นายอยากติดทีมบอลใช่ปะ อันนี้มันพังปอด วิ่งไม่ไหวแน่', next: 'right1', xp: 25 },
        { label: 'เงินก็แพง สุขภาพก็เสีย ไม่คุ้มเลยเพื่อน', next: 'right1', xp: 25 },
        { label: 'นายเคยบอกว่าอยากฟิตใช่ปะ อันนี้สวนทางเลย', next: 'right1', xp: 28 },
      ],
    },
    {
    ...
    },
    {
      ...
      choices: [
        ...
        { label: 'เก็บเงินไว้ซื้อเกม/ของที่อยากได้ดีกว่ามั้ย', next: 'right1', xp: 25 },
        { label: 'จำที่นายตั้งใจไว้ได้มั้ย อันนี้มันทำให้ไปไม่ถึงนะ', next: 'right1', xp: 28 },
      ],
    },
    {
      type: 'dialogue', id: 'right1', speaker: 'friend2', next: 'choice2',
      text: '...เออ จริงดิ ฉันอยากติดทีมบอล ไม่อยากให้ปอดพังตั้งแต่ตอนนี้',
    },
    {
