  ...
  nodes: [
    {
      ...
      text: 'น้องนักสืบ — มีเพื่อนคนหนึ่งอยากเลิกบุหรี่ไฟฟ้ามาเป็นอาทิตย์แล้ว แต่พอถึงช่วงที่ "อยากสูบมากๆ" ก็มักจะต้านไม่ไหว เราพอจะมีสูตรหรือเทคนิคช่วยเขาไหม?',
    },
    {
      type: 'dialogue', id: 'd2', speaker: 'narrator', next: 'mg1',
      text: 'สูตร 4D คือเทคนิคทางพฤติกรรมศาสตร์ — เมื่อมีอาการ "อยากสูบ" ให้ใช้ 4 ขั้นตอนนี้ ความอยากจะค่อยๆ สงบลงภายใน 5 นาที',
    },
    {
    ...
    },
    {
      ...
      text: 'เก่งมากเลย! ตอนนี้เราช่วยเพื่อนรับมือกับอาการอยากสูบได้แล้ว แต่การป้องกันก่อนจะติดย่อมดีที่สุด ทีมนักสืบสุขภาพในโรงเรียนควรจะเริ่มทำอะไรบ้างดี?',
    },
    {
      ...
      choices: [
        ...
        { label: 'อบรมเพื่อน + ทำกิจกรรมสร้างสรรค์ + ช่วยเหลือเพื่อนอย่างลับๆ',
          next: 'right1', xp: 35 },
    ...
    },
    {
      ...
      text: 'ยอดเยี่ยมมาก! ทีมนักสืบสุขภาพจะช่วย (1) ให้ความรู้ที่ถูกต้อง (2) จัดกิจกรรมสร้างสรรค์เชิงบวก และ (3) คอยช่วยเหลือเพื่อนอย่างลับๆ แบบนี้โรงเรียนจะปลอดภัยแน่นอน',
    },
    {
