...
export const scenario19: Scenario = {
  ...
  nodes: [
    ...
    },
    {
      ...
      pairs: [
        { left: 'วิตามินอีอะซิเตท',
          right: 'ตัวการหลักของ EVALI — เคลือบปอดจนหายใจไม่ได้',
          source: 'CDC EVALI Investigation — NEJM 2020' },
        { left: 'ไดอะซิทิล (สารแต่งกลิ่น)',
          right: '"ปอดป๊อปคอร์น" — ปอดเป็นแผลเป็นถาวร',
          source: 'American Lung Association — Diacetyl in Flavored E-Cig' },
        { left: 'โลหะหนักจากขดลวด (ตะกั่ว/นิกเกิล)',
          right: 'สะสมในไตและสมอง',
    ...
    },
    {
      ...
      title: 'บันทึกนักสืบ 📓',
      body: 'EVALI เจอครั้งแรกปี 2019 ที่สหรัฐฯ ป่วยกว่า 2,800 คน เสียชีวิต 68 คน 💔\nในไทยน้ำยาเป็นของเถื่อน ไม่มีการตรวจคุณภาพ เคสจึงเพิ่มขึ้นทุกปี',
