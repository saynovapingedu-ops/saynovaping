...
export const scenario17: Scenario = {
  ...
  intro: [
    ...
    'มีคนแปลกหน้าส่ง DM เข้ามาทักทาย — แล้วชวนซื้อ "พอตรสผลไม้" ราคาถูก',
    'นักสืบสุขภาพต้องรู้ทันรูปแบบใหม่ของการขาย vape',
  ],
  nodes: [
    {
      type: 'dialogue', id: 'd1', speaker: 'dm-stranger', speakerName: 'คนแปลกหน้าใน Discord', next: 'd2',
      text: 'เฮ้! เล่นเกมตึงมากเลย ใช้เทคนิคอะไรเหรอ? เออ... สนใจพอตรสองุ่นไหม เครื่องสวยมาก ราคาแค่ 250 บาทเองนะ',
    },
    {
      type: 'dialogue', id: 'd2', speaker: 'narrator', next: 'choice1',
      text: 'สังเกตสิ — เขาเริ่มด้วยคำชมเพื่อสร้างความสนิทสนม แล้วค่อยเนียนเสนอขายของ นี่คือเทคนิคที่ผู้ค้าชอบใช้เจาะกลุ่มเยาวชนในเกมออนไลน์',
    },
    {
      type: 'choice', id: 'choice1', speaker: 'player',
      prompt: 'คุณจะตอบอย่างไร?',
      choices: [
        { label: 'ไม่ตอบ + บล็อกแชททันที + แคปหน้าจอรายงานครู',
          next: 'right1', xp: 35 },
        { label: 'ราคาเท่าไหร่ขอดูรูปหน่อย แค่อยากรู้เฉยๆ',
          next: 'wrong1', xp: 0,
          reflection: 'ห้ามตอบเด็ดขาด — แค่ตอบว่าอยากรู้ เขาก็จะมองว่าคุณเริ่มสนใจและตามตื๊อไม่หยุด' },
        { label: 'ผม/หนูยังเป็นเด็กอยู่ ไม่ซื้อหรอกครับ/ค่ะ',
          next: 'okay1', xp: 10,
          reflection: 'การบอกอายุ = ยืนยันว่าคุณเป็นเยาวชนตรงกลุ่มเป้าหมาย เขาจะยิ่งตื๊อหนักขึ้น' },
      ],
    },
    {
