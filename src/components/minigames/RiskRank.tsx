          ...
          {correctCount < items.length && (
            <div className="mb-3 text-left bg-white rounded-xl border border-warning-300 p-3 shadow-sm space-y-2">
              ...
              <div className="text-[11px] text-slate-700 bg-warning-50 p-2.5 rounded-lg border border-warning-200 mt-2 leading-relaxed">
                📌 <b>ข้อคิดสำคัญ:</b> ทั้ง <i>"ลองบุหรี่ไฟฟ้าเป็นครั้งคราว"</i> และ <i>"สูบบุหรี่มวนเป็นครั้งคราว"</i> ถูกจัดอยู่ในกลุ่ม <b>🟠 เสี่ยงสูง</b> ร่วมกัน เนื่องจากนิโคตินทำให้สมองวัยรุ่นเสพติดได้รวดเร็วและทำลายปอดไม่ต่างกัน ส่วน <i>"ดื่มน้ำอัดลมทุกมื้อ"</i> อยู่ใน <b>🟡 เสี่ยงปานกลาง</b> จากน้ำตาลสูงแต่ไม่มีสารเสพติดนิโคติน
              </div>
            </div>
          )}
