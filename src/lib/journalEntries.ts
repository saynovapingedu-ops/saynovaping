...
export const JOURNAL_ENTRIES: JournalEntry[] = [
  // === Hero Arc (1-8) — เส้นทางนักสืบเริ่มต้น ===
  {
    ...
    lesson: 'การตลาดบุหรี่ไฟฟ้าไม่ได้พุ่งเป้ามาที่ "ผู้ใหญ่เลิกบุหรี่" เหมือนที่บริษัทอ้าง — เด็กอายุ 13-17 คือกลุ่มเป้าหมายหลัก เพราะตลาดผู้ใหญ่อิ่มตัวแล้ว สี รส และ packaging ทำให้รู้สึก "ปลอดภัย" ทั้งที่ระดับนิโคตินสูงกว่าบุหรี่มวน',
    howTo: [
  ...
  },
  {
    ...
    lesson: 'นิโคตินรสผลไม้/ลูกอม ทำให้ "เริ่มลอง" ง่ายขึ้นมาก เพราะกลิ่น/รสไม่เหมือนสารพิษ สมองวัยรุ่นรับ "รางวัล" จากน้ำตาล+นิโคตินพร้อมกัน ติดเร็วกว่าสูบบุหรี่มวน',
    howTo: [
